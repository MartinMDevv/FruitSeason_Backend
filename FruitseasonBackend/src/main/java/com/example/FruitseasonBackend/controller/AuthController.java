...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest req) {
        try {
            ...
            UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(req.username(),
                    req.password());
    ...
    // ============= NOTA IMPORTANTE =============
    // El endpoint /subscribe debería estar en un controlador separado
    // como SubscriptionController.java, ya que no es parte de la autenticación
    // Además, NUNCA manejes datos de tarjetas directamente
    // Usa servicios como Stripe, PayPal, MercadoPago, etc.
}